...
public class SpruceLogBiome extends RandomAdditionsModElements.ModElement {
	public static Biome biome;
	public SpruceLogBiome(RandomAdditionsModElements instance) {
		super(instance, 9);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.SPRUCE_LOG.getDefaultState(),
								Blocks.SPRUCE_LOG.getDefaultState(), Blocks.SPRUCE_LOG.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("random_additions:spruce_log"));
			}
		}
	}
	@Override

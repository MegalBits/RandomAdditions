...
public class AcaciaLogBiome extends RandomAdditionsModElements.ModElement {
	public static Biome biome;
	public AcaciaLogBiome(RandomAdditionsModElements instance) {
		super(instance, 16);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.ACACIA_LOG.getDefaultState(),
								Blocks.ACACIA_LOG.getDefaultState(), Blocks.ACACIA_LOG.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("random_additions:acacia_log"));
			}
		}
	}
	@Override

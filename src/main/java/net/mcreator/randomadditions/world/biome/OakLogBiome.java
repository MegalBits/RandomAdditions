...
public class OakLogBiome extends RandomAdditionsModElements.ModElement {
	public static Biome biome;
	public OakLogBiome(RandomAdditionsModElements instance) {
		super(instance, 5);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.OAK_LOG.getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("random_additions:oak_log"));
			}
		}
	}
	@Override

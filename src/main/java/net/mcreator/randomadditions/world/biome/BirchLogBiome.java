...
public class BirchLogBiome extends RandomAdditionsModElements.ModElement {
	public static Biome biome;
	public BirchLogBiome(RandomAdditionsModElements instance) {
		super(instance, 8);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.BIRCH_LOG.getDefaultState(),
								Blocks.BIRCH_LOG.getDefaultState(), Blocks.BIRCH_LOG.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("random_additions:birch_log"));
			}
		}
	}
	@Override

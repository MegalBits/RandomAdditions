...
public class JungleLogBiome extends RandomAdditionsModElements.ModElement {
	public static Biome biome;
	public JungleLogBiome(RandomAdditionsModElements instance) {
		super(instance, 13);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.JUNGLE_LOG.getDefaultState(),
								Blocks.JUNGLE_LOG.getDefaultState(), Blocks.JUNGLE_LOG.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("random_additions:jungle_log"));
			}
		}
	}
	@Override

...
public class RedstoneGoldBlock extends RandomAdditionsModElements.ModElement {
	@ObjectHolder("random_additions:redstone_gold")
	public static final Block block = null;
	public RedstoneGoldBlock(RandomAdditionsModElements instance) {
		super(instance, 46);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("random_additions:redstone_gold_match"),

...
public class RawIronItem extends RandomAdditionsModElements.ModElement {
	@ObjectHolder("random_additions:raw_iron")
	public static final Item block = null;
	public RawIronItem(RandomAdditionsModElements instance) {
		super(instance, 22);
	}

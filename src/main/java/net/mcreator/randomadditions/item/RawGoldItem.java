...
public class RawGoldItem extends RandomAdditionsModElements.ModElement {
	@ObjectHolder("random_additions:raw_gold")
	public static final Item block = null;
	public RawGoldItem(RandomAdditionsModElements instance) {
		super(instance, 23);
	}
